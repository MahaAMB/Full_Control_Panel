...
if(isset($_POST["saveBtn"])){
    ...
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '1'";
    $query = mysqli_query($db_con,$sql);
    $RangeVal = $_POST['engine2'];
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '2'";
    $query = mysqli_query($db_con,$sql);
    $RangeVal = $_POST['engine3'];
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '3'";
    $query = mysqli_query($db_con,$sql);
    $RangeVal = $_POST['engine4'];
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '4'";
    $query = mysqli_query($db_con,$sql);
    $RangeVal = $_POST['engine5'];
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '5'";
    $query = mysqli_query($db_con,$sql);
    $RangeVal = $_POST['engine6'];
    $sql = "UPDATE fullcontrolpanelmobile SET Degree = '$RangeVal' WHERE EngineNum = '6'";
    $query = mysqli_query($db_con,$sql);
}
...
if(isset($_POST["onBtn"])){
    $sql = "UPDATE fullcontrolpanelmobile SET State = '1' where State = '0'";
    $query = mysqli_query($db_con,$sql);
}

/* Off button is pressed to update the table with the state */
if(isset($_POST["offBtn"])){
        $sql = "UPDATE fullcontrolpanelmobile SET State = '0' where State = '1'";
        $query = mysqli_query($db_con,$sql);
}

/* Store the direction of the robot movement in the DB */
 if (isset($_POST["fwd"])) {
            $sql = "UPDATE fullcontrolpanelmobile SET Direction = 'Robot is moving forward'";
            $query = mysqli_query($db_con, $sql);
        }
            
if (isset($_POST["bwd"])) {
            $sql = "UPDATE fullcontrolpanelmobile SET Direction = 'Robot is moving backward'";
            $query = mysqli_query($db_con, $sql);
        }
            
if (isset($_POST["stop"])) {
            $sql = "UPDATE fullcontrolpanelmobile SET Direction = 'Robot stopped moving'";
            $query = mysqli_query($db_con, $sql);
        }
            
if (isset($_POST["right"])) {
            $sql = "UPDATE fullcontrolpanelmobile SET Direction = 'Robot is moving to the right'";
            $query = mysqli_query($db_con, $sql);
        }

if (isset($_POST["left"])) {
            $sql = "UPDATE fullcontrolpanelmobile SET Direction = 'Robot is moving to the left'";
            $query = mysqli_query($db_con, $sql);
        }
